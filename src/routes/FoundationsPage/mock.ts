...
export const nkoCardsData = [
			{image: nkoPic1,
				name: 'Заголовок',
				description: 'Мы знакомы с ProCharity 2 года. Это наша первая платформа интеллектуального волонтёрства. Регистрация и модерация прошли быстро. Но сначала было сложно довериться стороннему волонтёру. А теперь ProCharity —  незаменимый помощник в решении наших задач: от консультации бухгалтера до помощи дизайнера.',
				category: 'Москва'
			},
			{image: nkoPic1,
